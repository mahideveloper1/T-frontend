...
export type GetCurrentUserQuery = { __typename?: 'Query', getCurrentUser?: { __typename?: 'User', id: string, firstName: string, email: string, profileImageUrl?: string | null, lastName?: string | null, tweets?: Array<{ __typename?: 'Tweet', id: string, content: string } | null> | null } | null };
